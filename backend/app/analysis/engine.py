...
INLINE_FREE_FROM_CUES = ["içermez", "icermez", "yoktur", "bulunmaz", "does not contain", "contains no", "free from"]
INLINE_MAY_CONTAIN_CUES = ["eser miktarda", "iz miktarda", "may contain", "iz içerebilir", "iz icerebilir", "traces of"]
INLINE_ALLERGEN_TERMS = [
    "alerjen", "allergen", "gluten", "süt", "sut", "soya", "fındık", "findik", "yumurta",
    "yer fıstığı", "yer fistigi", "susam", "ceviz", "badem", "milk", "soy", "hazelnut",
    "egg", "sesame", "peanut", "wheat",
]
INLINE_PRESENCE_VERBS = ["içerir", "icerir", "içermektedir", "icermektedir", "contains"]
